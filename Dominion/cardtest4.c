...
//test for the baron card, inside the cardEffect function
int main(){
int card = baron;
int choice1 = 0;
int choice2 = 0;
...
int handPos = 0;
int * bonus = NULL;
//go into cardEffect and pass in baron as a parameter so that the code associated with it can be executed
